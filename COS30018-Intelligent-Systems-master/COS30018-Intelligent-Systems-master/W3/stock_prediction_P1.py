...
def load_data(ticker, n_steps=50, scale=True, shuffle=True, lookup_step=1, split_by_date=True,
    ...
    if isinstance(ticker, str):
        # load it using yfinance library (more reliable than yahoo_fin)
        ...
        # Rename columns to match expected format (lowercase, no spaces)
        ...
        # If 'adjclose' doesn't exist but 'close' does, use 'close' as 'adjclose'
